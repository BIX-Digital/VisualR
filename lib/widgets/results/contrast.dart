...
class ContrastResultsList extends ResultsList<ContrastTestEntity> {
  const ContrastResultsList({
    super.key,
  ...
  List<DataRow> getRows(
    List<ContrastTestEntity> sequences,
    Prefs prefs,
  ) =>
      sequences
        ...
        (sequence) {
          final List<Widget> cells = [
            ...
            Text(
              sequence.toDTO().summary.left!.avg.toString(),
              style: AppThemes().small,
            ),
            Text(
              sequence.toDTO().summary.right!.avg.toString(),
              style: AppThemes().small,
            ),
          ];
