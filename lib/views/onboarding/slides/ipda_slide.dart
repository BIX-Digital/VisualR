...
class IPDASlide extends StatelessWidget {
  final VoidCallback action;
  const IPDASlide({super.key, required this.action});

  @override
  Widget build(BuildContext context) {
    return OnboardingLayout(
      title: AppLocalizations.of(context)!.onboarding_pupillary_distance,
      body: Container(
        alignment: Alignment.topLeft,
        child: Text(
          AppLocalizations.of(context)!.onboarding_pupillary_distance_copy,
